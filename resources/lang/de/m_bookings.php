...
return [
    ...
    'bookings' => [
        ...
        'trash' => [
            ...
            'trash' => 'Papierkorb',
            'back_to_bookings' => 'Zurück zu Buchungen',
    ...
    'filters' => [
        ...
        'tour_dates' => 'Tour-Daten',
        'tour_schedule' => 'Tour und Zeitplan',
        'status_reference' => 'Status und Referenz',
        'dates'            => 'Daten',
    ...
    'reports' => [
        ...
        'pdf_title'            => 'Buchungsbericht - ' . config('company.short_name') . '',
        'general_report_title' => 'Allgemeiner Buchungsbericht - ' . config('company.name') . '',
