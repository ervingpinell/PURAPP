...
return [
    ...
    'requests' => [
        ...
        'errors' => [
            ...
            'wait_one_minute' => 'Por favor espera al menos un minuto antes de reenviar.',
        ],
    ...
    'public' => [
        ...
        'select_rating'     => 'Selecciona tu calificación',
        
        // Rating levels
        'rating_excellent'     => 'Excelente',
        'rating_good'          => 'Bueno',
        'rating_average'       => 'Regular',
        'rating_below_average' => 'Malo',
        'rating_poor'          => 'Muy malo',
        ...
        'labels'       => [
            ...
            'author_email' => 'Tu email (opcional)',
            'submit'       => 'Enviar reseña',
        ],
        'thanks'       => '¡Gracias por tu reseña! 🌿',
        'thanks_body'  => 'Tu opinión es muy importante y nos ayuda a mejorar. Realmente lo apreciamos.',
        'thanks_farewell' => "Esperamos que hayas disfrutado tu tiempo con nosotros y verte de nuevo pronto.\n\n🇨🇷 ¡Pura Vida mae! 🇨🇷",
        'thanks_dup'   => '¡Gracias! Ya teníamos tu reseña registrada 🙌',
        'expired'      => 'Este enlace ha expirado, pero muchas gracias por tu intención 💚',
        'used'         => 'Esta solicitud ya ha sido utilizada.',
