...
return [
    ...
    'faq_more_questions' => 'Haben Sie weitere Fragen?',

    // 29. EMAIL PREVIEW
    'email_preview' => [
        'page_title' => 'E-Mail Vorschau',
        'title' => 'Vorschau-System',
        'description' => 'Vorschau aller E-Mail-Vorlagen ohne Versand. Verwendet echte Buchungsdaten, falls verfügbar, oder Beispieldaten.',
        'labels' => [
            'bookings' => 'Kundenbuchungen',
            'reviews' => 'Bewertungen',
            'auth' => 'Benutzer & Konto',
            'admin' => 'Admin & Berichte',
        ],
        'types' => [
            ...
            'booking-expired' => 'Buchung Abgelaufen (Unbezahlt)',
            'payment-success' => 'Zahlung Erfolgreich',
            'payment-failed' => 'Zahlung Fehlgeschlagen',
            'payment-reminder' => 'Zahlungserinnerung',
            'review-request' => 'Link zur Bewertungsanfrage',
            'review-reply' => 'Benachrichtigung über Antwort auf Bewertung',
            'review-submitted' => 'Bewertung Eingereicht (Admin)',
            'welcome' => 'Willkommens-E-Mail',
            'password-setup' => 'Konto-Einrichtung (Passwort setzen)',
            'verify-email' => 'E-Mail-Adresse Bestätigen',
            'reset-password' => 'Passwort-Reset Anfrage',
            'password-updated' => 'Passwort Aktualisiert Hinweis',
            'account-locked' => 'Konto Gesperrt Benachrichtigung',
            'email-change-verification' => 'E-Mail-Änderung Bestätigung',
            'email-change-completed' => 'E-Mail-Änderung Abgeschlossen',
            'admin-booking-created' => 'Neue Buchungsbenachrichtigung (Admin)',
            'admin-paid-booking' => 'Bezahlte Buchung (Admin)',
            'admin-booking-expiring' => 'Buchung läuft ab Warnung',
            'admin-daily-report' => 'Täglicher Betriebsbericht',
            'contact-message' => 'Kontaktformular Nachricht',
        ],
        'tools_title' => 'E-Mail Werkzeuge',
        'view_telescope' => 'Gesendete E-Mails Ansehen (Telescope)',
        'config_button' => 'E-Mail Konfiguration',
        'tip_title' => 'Tipp:',
        'tip_text' => 'Klicken Sie auf einen Link, um ihn in einem neuen Tab zu öffnen. Die Vorschau verwendet das gleiche Layout und den gleichen Stil wie echte E-Mails.',
        'config_title' => 'E-Mail Adressen Konfiguration',
        'table' => [
            'purpose' => 'Zweck',
            'address' => 'Adresse',
            'env_var' => 'Umgebungsvariable',
            'from' => 'Von (No-Reply)',
            'reply_to' => 'Antwort an (Support)',
            'admin_notify' => 'Admin Benachrichtigungen',
