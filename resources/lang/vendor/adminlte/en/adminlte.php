...
return [
    ...
    'cookies' => [
        'banner_aria' => 'Cookie notice',
        'title' => 'We use cookies',
        'message' => 'This site uses cookies to improve your experience. You can accept all, reject non-essential ones, or customize your preferences.',
        'accept_all' => 'Accept all',
        'reject' => 'Reject',
        'customize' => 'Customize',
        'customize_title' => 'Customize cookies',
        'save_preferences' => 'Save preferences',
        'change_preferences' => 'Cookie preferences',
        'close' => 'Close',
        'always_active' => 'Always active',
        'learn_more' => 'Learn more about cookies',

        'essential' => 'Essential cookies',
        'essential_desc' => 'Necessary for the basic functioning of the site (login, cart, security)',

        'functional' => 'Functional cookies',
        'functional_desc' => 'Remember your preferences such as language, currency or theme',

        'analytics' => 'Analytics cookies',
        'analytics_desc' => 'Help us understand how you use the site to improve it (Google Analytics)',
    ...
    'email' => [
        'payment_reminder' => [
            ...
            'auto_charge_warning' => 'Your card will be automatically charged in <strong>:days days</strong> on :date.',
            'pay_now_intro' => 'You can also pay now using the link below:',
            'pay_now' => 'Pay Now',
        ],
        'payment_failed' => [
            'title' => 'Payment Failed',
            'intro' => 'We were unable to process your payment for the following booking:',
            'update_payment' => 'Please update your payment method or try again to secure your booking.',
            'try_again' => 'Try Again',
            'support_footer' => 'If you continue to experience issues, please contact our support team.',
        ],
        'payment_success' => [
            'title' => 'Payment Successful',
            'intro' => 'Thank you! Your payment has been received.',
            'confirmed_message' => "Your booking is now confirmed. We'll send you more details closer to your tour date.",
            'create_account_view_booking' => 'Create Account & View Booking',
            'view_my_bookings' => 'View My Bookings',
        ],
        'booking_expired' => [
            'title' => 'Booking Expired',
            'intro' => 'Your booking request has expired because payment was not completed in time.',
            'rebook_message' => 'If you would like to proceed with this tour, please create a new booking.',
            'book_again' => 'Book Again',
        ],
        'booking_confirmed_subject' => 'Booking Confirmed #:reference',
        'booking_created_subject' => 'Booking Request #:reference',
        'booking_cancelled_subject' => 'Booking Cancelled #:reference',
        'booking_updated_subject' => 'Booking Updated #:reference',
        ...
        'date' => 'Date',
        'thanks' => 'Thanks',
        'contact_footer' => "If you have any questions, please don't hesitate to contact us.",
    ],

    // 29. EMAIL PREVIEW
    'email_preview' => [
        'page_title' => 'Email Previews',
        'title' => 'Email Preview System',
        'description' => 'Preview all email templates without sending them. This uses real booking data when available, or sample data for demonstration.',
        'labels' => [
        ...
        'tools_title' => 'Email Tools',
        'view_telescope' => 'View Sent Emails (Telescope)',
        'config_button' => 'Email Configuration',
        'tip_title' => 'Tip:',
        'tip_text' => 'Click any email link to open it in a new tab. The preview uses the same layout and styling as actual emails.',
        'config_title' => 'Email Addresses Configuration',
        'table' => [
            'purpose' => 'Purpose',
            'address' => 'Address',
            'env_var' => 'Environment Variable',
            'from' => 'From (No-Reply)',
            'reply_to' => 'Reply-To (Support)',
