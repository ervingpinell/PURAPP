...
return [
    ...
    'profile_updated_email_change_pending' => 'Seu perfil foi atualizado. Enviamos um link para o seu novo e-mail para confirmar a alteração. Até que você confirme, continuaremos usando o seu e-mail atual.',
    ...
    'enable_2fa_to_continue' => 'Você deve ativar a autenticação de dois fatores (2FA) para acessar o painel de administração.',
    ...
    'notes'             => 'Observações',
    'notes_placeholder' => 'Algo que precisamos saber? (alergias, mobilidade, comemorações etc.)',
    'notes_help'        => 'Essas observações serão enviadas para nossa equipe junto com a sua reserva.',
    ...
    'meta' => [
        'home_title' => 'Green Vacations Costa Rica | Tours e Aventuras em La Fortuna',
        'home_description' => 'Explore os melhores tours em La Fortuna e Vulcão Arenal. Aventuras sustentáveis, caminhadas e mais com Green Vacations Costa Rica.',
        'tours_title' => 'Tours e Atividades em La Fortuna | Green Vacations',
    ...
    // 29. EMAIL PREVIEW
    'email_preview' => [
        'page_title' => 'Pré-visualização de E-mails',
        'title' => 'Sistema de Pré-visualização',
        'description' => 'Pré-visualize todos os modelos de e-mail sem enviá-los. Usa dados reais de reserva quando disponíveis, ou dados de exemplo.',
        'labels' => [
        ...
        'types' => [
            ...
            'booking-expired' => 'Reserva Expirada (Não Paga)',
            'payment-success' => 'Pagamento com Sucesso',
            'payment-failed' => 'Pagamento Falhou',
            'payment-reminder' => 'Lembrete de Pagamento',
            'review-request' => 'Link de Solicitação de Avaliação',
            'review-reply' => 'Notificação de Resposta de Avaliação',
            'review-submitted' => 'Avaliação Enviada (Admin)',
            'welcome' => 'E-mail de Boas-vindas',
            'password-setup' => 'Configuração de Conta (Definir Senha)',
            'verify-email' => 'Verificar Endereço de E-mail',
            'reset-password' => 'Solicitação de Redefinição de Senha',
            'password-updated' => 'Aviso de Senha Atualizada',
            'account-locked' => 'Notificação de Conta Bloqueada',
            'email-change-verification' => 'Verificação de Alteração de E-mail',
            'email-change-completed' => 'Alteração de E-mail Concluída',
            'admin-booking-created' => 'Nova Notificação de Reserva (Admin)',
            'admin-paid-booking' => 'Notificação de Reserva Paga',
            'admin-booking-expiring' => 'Alerta de Reserva Expirando',
            'admin-daily-report' => 'Relatório Operacional Diário',
            'contact-message' => 'Mensagem do Formulário de Contato',
        ],
        'tools_title' => 'Ferramentas de E-mail',
        'view_telescope' => 'Ver E-mails Enviados (Telescope)',
        'config_button' => 'Configuração de E-mail',
        'tip_title' => 'Dica:',
        'tip_text' => 'Clique em qualquer link para abri-lo em uma nova aba. A pré-visualização usa o mesmo layout e estilo dos e-mails reais.',
        'config_title' => 'Configuração de Endereços de E-mail',
        'table' => [
            'purpose' => 'Propósito',
            'address' => 'Endereço',
            'env_var' => 'Variável de Ambiente',
            'from' => 'De (No-Reply)',
            'reply_to' => 'Responder para (Suporte)',
            'admin_notify' => 'Notificações de Admin',
            'booking_notify' => 'Notificações de Reserva',
        ],
    ],
];
