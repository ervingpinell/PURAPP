...
return [
    ...
    'amenity' => [
        ...
        'ui' => [
            ...
            'delete_confirm_html'  => '<b>:label</b> será excluída e esta ação não poderá ser desfeita.',
    ...
    'schedule' => [
        ...
        'ui' => [
            ...
            'assign_to_tour'     => 'Atribuir horário ao tour ":tour"',
            ...
            'delete_confirm_title' => 'Excluir definitivamente?',
            'delete_confirm_html'  => '<b>:label</b> (global) será excluído e esta ação não poderá ser desfeita.',
        ...
        'error' => [
            ...
            'detach'               => 'Não foi possível remover o horário do tour.',
    ...
    'itinerary_item' => [
        ...
        'ui' => [
            ...
            'delete_forever'       => 'Excluir definitivamente',
            'delete_confirm_title' => 'Excluir definitivamente?',
            'delete_confirm_html'  => '<b>:label</b> será excluído e esta ação não poderá ser desfeita.',
            'yes_delete'           => 'Sim, excluir',
            'item_this'            => 'este item',
    ...
    'itinerary' => [
        ...
        'ui' => [
            ...
            'select_one_title'      => 'Você deve selecionar ao menos um item',
        ...
        'validation' => [
            ...
            'items' => [
                'required'      => 'Você deve selecionar ao menos um item.',
                'array'         => 'O formato dos itens não é válido.',
                'min'           => 'Você deve selecionar ao menos um item.',
    ...
    'tour' => [
        ...
        'schedules_form' => [
            ...
            'create_block_text'      => 'Se você precisa de um horário que não existe, pode criá-lo aqui marcando "Criar este horário e atribuí-lo ao tour".',
        ...
        'summary' => [
            ...
            'create_note' => 'Os horários, preços, idiomas e amenidades aparecerão aqui após salvar o tour.',
        ],
        ...
        'alerts' => [
            ...
            'purge_text_with_bookings' => 'Este tour possui :count reserva(s). Elas não serão removidas; ficarão sem tour associado.',
        ...
        'hints' => [
            'group_size' => 'Capacidade/grupo recomendada para este tour.',
        ],
