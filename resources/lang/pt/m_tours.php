...
'image' => [
    ...
    'limit_reached_text'  => 'O número máximo de imagens para este passeio foi atingido.',
    ...
    'skipped_by_type'       => "Arquivos ignorados por tipo:\n:detail",
    'skipped_by_type_line'  => "• :label: :count",
    'save_errors'           => "Alguns arquivos não puderam ser salvos:\n:detail",
    'save_errors_line'      => "• :name: :message",

    'ui' => [
        'page_title_pick'     => 'Imagens de Passeios — Escolher passeio',
        ...
        'add_more_btn'        => 'Adicionar mais imagens',
        'delete_btn'         => 'Excluir',
    ],
],
