...
<head>
    ...
    <style>
        ...
        .reserva-section{background:#fff;border:1px solid #e0e0e0;border-radius:8px;padding:20px;margin-bottom:25px;box-shadow:0 4px 10px rgba(0,0,0,0.05);}
        .section-title{font-weight:700;color:var(--green-base);margin-bottom:15px;font-family:var(--font-heading);font-size:18px;}
        .dato{margin-bottom:8px;display:flex;align-items:baseline;}
        .dato strong{color:var(--green-dark);min-width:120px;display:inline-block;font-family:var(--font-heading);font-weight:600;font-size:13px;}
        .dato span,.dato small{font-family:var(--font-body);font-size:14px;color:var(--text-color);}
        ...
        .resumen-general{background:#eaf5ed;border:1px solid var(--green-base);border-radius:10px;padding:25px;margin-top:40px;box-shadow:0 5px 15px rgba(0,0,0,0.08);}
        .resumen-general .dato{font-size:16px;font-family:var(--font-heading);font-weight:600;color:var(--green-dark);}
        .resumen-general .dato strong{min-width:150px;}
        @media print{body{background:none;padding:0;margin:0}.report-container{box-shadow:none;border:none;border-radius:0;margin:0;max-width:initial;padding:0}.reserva-section{border:1px solid #ccc;box-shadow:none;page-break-inside:avoid;margin-bottom:15px}.line-separator{border-top:1px solid #ddd}h2{font-size:24px}.section-title{font-size:16px}.total{font-size:16px}.resumen-general{box-shadow:none;border:1px solid #ccc}}
    </style>
</head>
<body>
<div class="report-container">
    ...
    @foreach($reservas as $reserva)
        @php
            ...
            $aQty   = (int)($detail->adults_quantity ?? 0);
            $kQty   = (int)($detail->kids_quantity ?? 0);
            ...
            $labelDiscount = __('receipt.discount_label', [], false) ?: 'Descuento';
            $labelSurcharge = __('receipt.surcharge_label', [], false) ?: 'Recargo';
        ...
        <div class="reserva-section">
            ...
            @if ($promo && $delta > 0)
                <div class="dato">
                    ...
                    <span style="color: {{ $op === 'add' ? '#b45309' : 'green' }};">
