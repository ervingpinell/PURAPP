...
<div class="row mb-3">
    <div class="col-12">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('admin.products.itinerary.index') }}">
                    <i class="fas fa-list"></i> {{ __('m_tours.common.active') }}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.products.itinerary.trash') }}">
    ...
    <div class="card-body">
         <div class="row align-items-center">
            <div class="col-md-6 mb-2 mb-md-0">
                <form action="{{ route('admin.products.itinerary.index') }}" method="GET" class="d-flex">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.products.itinerary.index') }}" class="btn btn-outline-secondary ms-2" title="{{ __('m_tours.common.clear_search') }}">
        ...
        <div class="table-responsive">
            <table class="table table-bordered dt-responsive nowrap w-100" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center btn-action-group">
                                ...
                                <form action="{{ route('admin.products.itinerary.toggle', $itinerary) }}"
                                    method="POST"
                                ...
                                <form action="{{ route('admin.products.itinerary.destroy', $itinerary->itinerary_id) }}" 
                                      method="POST" 
                    ...
                    @include('admin.products.itinerary.partials.assign', ['items' => $items, 'itinerary' => $itinerary])
                    @include('admin.products.itinerary.partials.edit', ['itinerary' => $itinerary])
...
@include('admin.products.itinerary.partials.create')
