    ...
    <div class="container-fluid">
        ...
        <div class="schedules-header">
            ...
            <p class="small mb-0">
                ...
                <strong>
                    {{ $product->max_capacity ?? __('m_tours.schedule.ui.capacity_not_defined') }}
                </strong>
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.products.product-wizard.store.schedules', $product) }}">
            ...
            <div class="action-buttons">
                <a href="{{ route('admin.products.schedule.index') }}"
                            ...
                            @foreach($schedules ?? [] as $schedule)
                                @php
                                    $isChecked = in_array(
                                        ...
                                        old(
                                            'schedules',
                                            $product->schedules->pluck('schedule_id')->toArray()
                                        )
                                    );

                                    $pivot = $product->schedules
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                                        ...
                                        <div class="mt-2 mt-md-0" style="min-width: 180px;">
                                            ...
                                            <input type="number"
                                                   ...
                                                   max="999"
                                                   value="{{ $oldCapacity }}"
                                                   placeholder="{{ $product->max_capacity
                                                        ? __('m_tours.schedule.ui.capacity_placeholder_with_value', ['capacity' => $product->max_capacity])
                                                        : __('m_tours.schedule.ui.capacity_placeholder_generic') }}">
                                            <small class="text-muted d-block">
                                                @if($product->max_capacity)
                                                    {{ __('m_tours.schedule.ui.capacity_hint_with_value', ['capacity' => $product->max_capacity]) }}
                                                @else
            ...
            <form action="{{ route('admin.products.product-wizard.quick.schedule', $product) }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info small mt-3">
                        ...
                        @if($product->max_capacity)
                            {{ __('m_tours.schedule.ui.capacity_modal_info_with_value', ['capacity' => $product->max_capacity]) }}
                        @else
