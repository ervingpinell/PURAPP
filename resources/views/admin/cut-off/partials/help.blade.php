<div class="card shadow-sm">
  <div class="card-body">
    ...
    <ol class="mb-3">
      ...
      <li><strong>{{ __('m_config.cut-off.tabs.product') }}:</strong> {{ __('m_config.cut-off.help.product') }}</li>
    ...
    <div class="alert alert-info mb-0">
      ...
      <span class="badge badge-override me-1">{{ __('m_config.cut-off.badges.product') }}</span> ➜
