...
const showError = (title, text = '') => {
  Swal.fire({ icon:'error', title, text, confirmButtonText: @json(__('pickups.meeting_point.buttons.ok')), confirmButtonColor:'#3085d6' });
};
const confirmAction = (title, text, icon = 'warning', confirmText = @json(__('pickups.meeting_point.buttons.confirm')), cancelText = @json(__('pickups.meeting_point.buttons.cancel'))) => {
  return Swal.fire({ title, text, icon, showCancelButton:true, confirmButtonColor:'#3085d6', cancelButtonColor:'#d33', confirmButtonText:confirmText, cancelButtonText:cancelText });
};
...
editForm.addEventListener('submit', function(e) {
  ...
  if (!tname) {
    return Swal.fire({ icon:'error', title:@json(__('pickups.meeting_point.validation.missing_translated_name_title')), text:@json(__('pickups.meeting_point.validation.missing_translated_name_text')) });
  }
  confirmAction(
