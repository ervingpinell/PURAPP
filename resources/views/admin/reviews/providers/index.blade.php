...
@section('js')
  ...
  @if (session('ok')) <script>Swal.fire({icon:'success', title:@json(session('ok'))});</script>@endif
  @if (session('error')) <script>Swal.fire({icon:'error', title:@json(session('error'))});</script>@endif
