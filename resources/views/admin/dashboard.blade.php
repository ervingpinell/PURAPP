  ...
  <div class="col-md-12 mb-3">
    <div class="card">
      <div class="card-header bg-danger text-white">
        <h4 class="mb-0">{{ __('adminlte::adminlte.sections.available_tours') }}</h4>
      </div>
      <div class="card-body">
...
{{-- ======= Notificaciones (partial) ======= --}}
@include('admin.notifications', [
'capAlerts' => $capAlerts ?? [],
'capCritical' => $capCritical ?? null,
])
@stop
...
<style>
  ...
  .js-simple-toggle[aria-expanded="true"] .itin-chevron {
