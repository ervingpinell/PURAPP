...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>{{ __('m_tours.tour.ui.create_title') }}</h1>
                ...
                <ul class="nav nav-tabs" id="tourTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active"
                           ...
                           aria-selected="true"
                           title="{{ __('m_tours.tour.fields.details') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"
                           ...
                           aria-selected="false"
                           title="{{ __('m_tours.tour.fields.price') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"
                           ...
                           aria-selected="false"
                           title="{{ __('m_tours.tour.fields.itinerary') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"
                           ...
                           aria-selected="false"
                           title="{{ __('m_tours.tour.fields.schedules') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"
                           ...
                           aria-selected="false"
                           title="{{ __('m_tours.tour.fields.languages') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"
                           ...
                           aria-selected="false"
                           title="{{ __('m_tours.tour.fields.amenities') }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"
                           ...
                           aria-selected="false"
                           title="{{ __('m_tours.tour.fields.overview') }}">
