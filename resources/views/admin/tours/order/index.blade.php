...
<div class="order-wrap">
  ...
  <form method="get" action="{{ route('admin.tours.order.index') }}" class="mb-3">
  ...
  @if ($selected)
    ...
    <div id="list" class="list" data-type="{{ $selected->tour_type_id }}">
      @foreach ($tours as $i => $row)
        <div class="tour-item" draggable="true" data-id="{{ $row->tour_id }}">
          ...
          <div>
            ...
            <div class="tour-meta">ID: {{ $row->tour_id }}</div>
            --}}
          </div>
