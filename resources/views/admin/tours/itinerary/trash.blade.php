        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.tours.itinerary.index') }}">{{ __('m_tours.itinerary.title') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('m_tours.itinerary.ui.trash_title') }}</li>
                </ol>
            </div>
        </div>
    </div>
