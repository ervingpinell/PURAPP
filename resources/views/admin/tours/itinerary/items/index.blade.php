...
<div class="row mb-3">
    <div class="col-12">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('admin.tours.itinerary_items.index') }}">
                    <i class="fas fa-list"></i> {{ __('m_tours.common.active') }}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.tours.itinerary_items.trash') }}">
    ...
    <div class="card-body">
         <div class="row align-items-center">
            <div class="col-md-6 mb-2 mb-md-0">
                <form action="{{ route('admin.tours.itinerary_items.index') }}" method="GET" class="d-flex">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.tours.itinerary_items.index') }}" class="btn btn-outline-secondary ms-2" title="{{ __('m_tours.common.clear_search') }}">
