...
<div class="mt-3">
    <a href="{{ route('admin.tours.schedule.index') }}" class="btn btn-secondary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.tours.schedule.restore', $schedule->schedule_id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form action="{{ route('admin.tours.schedule.forceDelete', $schedule->schedule_id) }}" method="POST" class="d-inline" onsubmit="return confirm('{{ __('m_tours.common.confirm_force_delete') }}')">
                                        @csrf
                                        @method('DELETE')
