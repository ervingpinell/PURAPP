...
@section('content_header')
  <div class="d-flex justify-content-between align-items-center">
    <h1 class="mb-0">{{ __('m_tours.tour.ui.edit_title') }}: {{ $tour->name }}</h1>
...
@section('content')
  ...
  <form action="{{ route('admin.tours.update', $tour) }}" method="POST" id="tourForm" novalidate>
    @csrf
    @method('PUT')
    ...
    <div class="card card-primary card-outline card-outline-tabs">
      <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="tourTabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="summary-tab" data-bs-toggle="pill" href="#summary" role="tab" aria-controls="summary" aria-selected="true">
          ...
          <li class="nav-item">
            <a class="nav-link" id="prices-tab" data-bs-toggle="pill" href="#prices" role="tab" aria-controls="prices" aria-selected="false">
              <i class="fas fa-dollar-sign"></i> {{ __('m_tours.tour.fields.price') }}
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="itinerary-tab" data-bs-toggle="pill" href="#itinerary" role="tab" aria-controls="itinerary" aria-selected="false">
              <i class="fas fa-route"></i> {{ __('m_tours.tour.fields.itinerary') }}
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="schedules-tab" data-bs-toggle="pill" href="#schedules" role="tab" aria-controls="schedules" aria-selected="false">
              <i class="fas fa-clock"></i> {{ __('m_tours.tour.fields.schedules') }}
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="languages-tab" data-bs-toggle="pill" href="#languages" role="tab" aria-controls="languages" aria-selected="false">
              <i class="fas fa-language"></i> {{ __('m_tours.tour.fields.languages') }}
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="amenities-tab" data-bs-toggle="pill" href="#amenities" role="tab" aria-controls="amenities" aria-selected="false">
