...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
    ...
    <a href="{{ route('admin.tours.amenities.index') }}" class="btn btn-secondary">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-sm">
                                ...
                                <form action="{{ route('admin.tours.amenities.restore', $amenity->amenity_id) }}" method="POST" class="d-inline restore-form">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form action="{{ route('admin.tours.amenities.forceDelete', $amenity->amenity_id) }}" method="POST" class="d-inline force-delete-form">
                                    @csrf
                                    @method('DELETE')
