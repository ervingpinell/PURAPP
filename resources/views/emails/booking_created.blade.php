...
<body style="font-family: Arial, sans-serif; color: #333;">
    ...
    <p>Gracias por reservar con <strong>Green Vacations</strong>. Te confirmamos que hemos recibido tu solicitud.</p>
    ...
    <p>📌 <em>Te enviaremos una notificación cuando tu reserva sea confirmada.</em></p>

    <p>Si tienes alguna pregunta, contáctanos a <a href="mailto:info@greenvacations.com">info@greenvacations.com</a>.</p>

    <p>¡Disfruta de tu experiencia!<br>El equipo de Green Vacations 🌿</p>
</body>
</html>
