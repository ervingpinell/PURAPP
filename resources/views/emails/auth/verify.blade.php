                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table role="presentation" style="width: 100%; margin: 32px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ $url }}" style="display: inline-block; padding: 16px 32px; background: linear-gradient(135deg, #60a862, #256d1b); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
                                            {{ __('auth.verify_email.action') }}
                                        </a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 8px 0 0; word-break: break-all;">
                                <a href="{{ $url }}" style="color: #60a862; text-decoration: none; font-size: 14px;">{{ $url }}</a>
                            </p>
                        </td>
                    </tr>
