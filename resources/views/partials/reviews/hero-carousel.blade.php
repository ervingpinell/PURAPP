...
<div id="{{ $carouselId }}"
  ...
  <div class="carousel-inner">
    ...
    // 🟢 FIX: Ensure author is never empty-string
    $author = !empty($r['author_name']) ? $r['author_name'] : __('reviews.anonymous_guest');
    ...
    <div class="carousel-item {{ $idx === 0 ? 'active' : '' }}">
      ...
      <article class="hero-card">
        ...
        <div class="review-head">
          ...
          <div class="who-when">
            <div class="who text-dark font-weight-bold" style="color: #000 !important;">{{ $author }}</div>
      ...
      @else
      {{-- Iframe logic unchanged but keeping context --}}
      @php
      ...
      $shouldEager = $idx < $initialLoad;
        ...
        <div class="iframe-shell" style="--embed-h: {{ (int)$baseIframeHeight }}px;">
          ...
          <iframe
            ...
            style="--embed-h: {{ (int)$baseIframeHeight }}px;"></iframe>
        </div>
        </article>
        @endif
    </div>
