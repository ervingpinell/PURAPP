<div class="modal fade modal-under-navbar" id="confirmTourModal" tabindex="-1"
     aria-labelledby="confirmTourModalLabel" aria-hidden="true" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="confirmTourModalLabel">
          {{ __('adminlte::adminlte.redirect_to_tour') }}
        </h5>
