...
$countries = [
    ...
    // Muestra amplia mundial (puedes extenderla)
...
// Orden: favoritos primero, luego alfabético
...
@foreach ($countries as $c)
    @php
        ...
        $code  = $c['code'];
        $name  = $c['name'];
        // Por defecto selecciona Costa Rica (puedes cambiarlo)
        $selected = ($name === 'Costa Rica') ? 'selected' : '';
    @endphp
    <option value="{{ $value }}" data-name="{{ $name }}" data-code="{{ $code }}" {{ $selected }}>
        ({{ $code }})
    </option>
@endforeach
