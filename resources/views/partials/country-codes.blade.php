...
['name' => 'Bouvet Island', 'iso' => 'BV', 'code' => '+47'],
...
['name' => 'Costa Rica', 'iso' => 'CR', 'code' => '+506', 'fav' => true],
...
['name' => 'French Southern Territories', 'iso' => 'TF', 'code' => '+262'],
...
['name' => 'Heard Island and McDonald Islands', 'iso' => 'HM', 'code' => '+672'],
...
['name' => 'South Georgia and the South Sandwich Islands', 'iso' => 'GS', 'code' => '+500'],
...
['name' => 'Tristan da Cunha', 'iso' => 'TA', 'code' => '+290'],
...
['name' => 'United States', 'iso' => 'US', 'code' => '+1', 'fav' => true],
['name' => 'United States Minor Outlying Islands', 'iso' => 'UM', 'code' => '+1'],
...
// variable para saber si debemos usar el ISO o el PHONE CODE como value
$valueIsIso = $valueIsIso ?? false;
$showNames = $showNames ?? false;

// Si $selected es 'CR' (ISO) y $valueIsIso es false (esperamos phone code),
// necesitamos encontrar el phone code de CR para marcarlo.
// O al reves.
// Para simplificar, comparamos contra iso y code.
@endphp

@foreach ($countries as $c)
@php
$val = $valueIsIso ? $c['iso'] : $c['code'];
$text = $showNames ? $c['name'] : $c['code'];

// Logica de seleccion:
// Si $selectedCode coincide con $val, seleccionado.
// Pero tambien soportamos pasar 'CR' o '+506' y que trate de matchear
$selectedCodeNorm = strtoupper($selectedCode); // por si acaso
$match = ($selectedCode == $c['code']) || ($selectedCodeNorm == $c['iso']);
@endphp
<option
    value="{{ $val }}"
    data-name="{{ $c['name'] }}"
