    ...
    @foreach (['Full Day' => '6 - 9 Horas', 'Half Day' => '2 - 4 Horas'] as $type => $duration)
        ...
        <div class="tour-card" style="cursor: pointer;" data-bs-toggle="modal"
            ...
            <div class="card-body d-flex flex-column h-100">
                ...
                <a href="javascript:void(0)" class="btn btn-success w-100 btn-ver-tour" data-bs-toggle="modal"
                    data-bs-target="#modal-{{ Str::slug($type) }}">
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header text-white" style="background:#0f2419">
                        <h5 class="modal-title text-center w-100" id="modalLabel-{{ Str::slug($type) }}">{{ $type }} Tours
                        </h5>
                                    ...
                                    <div class="col-6 col-sm-6 col-md-6 col-xl-4 mb-4">
                                        <div class="tour-modal-card h-100">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                <h5 class="card-title card-title-text">{{ $tour->name }}</h5>
                                                ...
                                                @endphp
                                                <p class="text-muted small mb-2"><strong>{{ $label }}:</strong> {{ $rawLength }}
                                                    {{ $unit }}</p>
                                                ...
                                                <div class="mb-3 small mt-auto">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <strong
                                                            style="color: #006633;">${{ number_format($tour->adult_price, 2) }}</strong>
                                                    </div>
                                                    <div class="d-flex justify-content-between">
                                                        <span>{{ __('adminlte::adminlte.kid_price') }}</span>
                                                        <strong
                                                            style="color: #006633;">${{ number_format($tour->kid_price, 2) }}</strong>
                                                    </div>
                                                </div>
