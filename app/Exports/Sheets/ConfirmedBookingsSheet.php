...
class ConfirmedBookingsSheet implements FromCollection, WithHeadings, WithStyles, WithTitle
{
    protected $bookings;
    protected $date;
    ...
    {
        return [
            1 => ['font' => ['bold' => true, 'color' => ['rgb' => 'FFFFFF']], 'fill' => ['fillType' => 'solid', 'startColor' => ['rgb' => '28a745']]],
        ];
    }
