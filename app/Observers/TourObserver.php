 ...
 * TourObserver
 *
 * Observer específico para Tour que complementa el trait Auditable
...
{
    /**
     * Handle el evento "saving" del tour
     * Se ejecuta ANTES de guardar (create o update)
     */
    public function saving(Tour $tour): void
    {
        // Auto-asignar created_by si es nuevo tour
        if (!$tour->exists && !$tour->created_by && auth()->check()) {
     ...
     */
    public function deleting(Tour $tour): void
    {
