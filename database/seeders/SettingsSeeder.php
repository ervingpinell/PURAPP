    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'description' => 'Enviar email de recordatorio antes del tour',
                'validation_rules' => json_encode(['required', 'boolean']),
                'sort_order' => 3,
            ],
            [
            ...
            [
                'key' => 'payment.gateway.tilopay',
                'value' => '0',
                'type' => 'boolean',
                'category' => 'payment',
                'label' => 'TiloPay',
                'description' => 'Habilitar pagos con TiloPay (Costa Rica)',
                'validation_rules' => json_encode(['boolean']),
                'sort_order' => 2,
            ],
            [
                ...
                'description' => 'Habilitar pagos con Banco Nacional de Costa Rica',
                'validation_rules' => json_encode(['boolean']),
                'sort_order' => 3,
            ],
            [
                'key' => 'payment.gateway.bac',
                'value' => '0',
                'type' => 'boolean',
                'category' => 'payment',
                'label' => 'BAC Credomatic',
                'description' => 'Habilitar pagos con BAC Credomatic',
                'validation_rules' => json_encode(['boolean']),
                'sort_order' => 4,
            ],
            [
                'key' => 'payment.gateway.bcr',
                'value' => '0',
                'type' => 'boolean',
                'category' => 'payment',
                'label' => 'Banco de Costa Rica',
                'description' => 'Habilitar pagos con Banco de Costa Rica',
                'validation_rules' => json_encode(['boolean']),
                'sort_order' => 5,
            ],
            [
