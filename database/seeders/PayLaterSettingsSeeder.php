    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'description' => 'Permite a los clientes registrados reservar sin pago inmediato. Deben pagar manualmente antes del product.',
            ...
            [
                ...
                'value' => '24',
                'type' => 'integer',
                'label' => 'Horas antes del product para cancelar',
                'description' => 'Cancelar automáticamente reservas sin pagar X horas antes del product (1-72 horas).',
            ...
            [
                ...
                'description' => 'Número de días antes del product para enviar email recordatorio de pago al cliente (1-30 días).',
